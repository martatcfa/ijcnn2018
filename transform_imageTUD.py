...
def generateimage_Rotation():
    directory=  'cifar_test'
    directory_rot= 'cifar_test _rot315'
...
def generateimage_Affine():
    ...
    directory=  'cifar_test'
    directory_aff= 'cifar_test _affine'
    ...
    for i,filenames in enumerate(img_paths):
        ...
        #PASCAL                
        pts1 = np.float32([[5,5],[5,5],[5,5]])
        pts2 = np.float32([[10,10],[10,10],[15,15]])
...
def generateimage_Flip():
    #directory=  'cifar_test'
    #directory_flip= 'cifar_test_flip'
