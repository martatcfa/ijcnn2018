...
def generateimage_Rotation():
    directory=  'VOC2007_test/JPEGImages'
    directory_rot= 'VOC2007_test_rot180'
    ...
    for i,filenames in enumerate(img_paths):
        ...
        res_rot180 = rotate_about_center(img,180)
        ...
        listfile.append(directory_rot + filenames[os.path.splitext(filenames)[0].find('/'):] + ".jpg")
        print('read files:' + filenames)
...
listfile =generateimage_Rotation()
